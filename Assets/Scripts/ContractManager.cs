...
public class ContractManager : MonoBehaviour
{
    ...
    [Header("Hemlig bana")]
    public GameObject secretContractButton; // Knapp för hemlig bana i Inspector
    public string secretSceneName = "masiv_manshon_test_starecasel"; // Namnet på din hemliga scen
